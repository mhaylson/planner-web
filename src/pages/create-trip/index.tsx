...
export function CreateTripPage() {
  ...
  //o FormEvent pode ser disparado por qualquer elemento como: form, input, button, mas como preciso pegar o submit
  //de um form então eu digo que é do tipo HTMLFormElement
